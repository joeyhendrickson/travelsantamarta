...
It should be:
```
https://travelsantamarta.vercel.app/api/auth/google/callback
```

**Check for:**
- ✅ Exact match (no extra spaces, no trailing slash)
- ✅ `https://` (not `http://`)
- ✅ Correct domain (`travelsantamarta.vercel.app`)
...
❌ **Wrong:**
- `https://travelsantamarta.vercel.app/api/auth/google/callback/` (trailing slash)
- `https://travel-santa-marta-xyz.vercel.app/api/auth/google/callback` (different subdomain)
- `http://travelsantamarta.vercel.app/api/auth/google/callback` (http instead of https)
- `https://travelsantamarta.vercel.app/api/auth/google/callback ` (trailing space)

✅ **Correct:**
- `https://travelsantamarta.vercel.app/api/auth/google/callback` (exact match)
...
1. **Update Google Cloud Console:**
   ...
   - Add the correct one: `https://travelsantamarta.vercel.app/api/auth/google/callback`
   - Click **"SAVE"**

2. **Update Vercel:**
   - Edit `GOOGLE_REDIRECT_URI` environment variable
   - Set it to: `https://travelsantamarta.vercel.app/api/auth/google/callback`
...
- [ ] Google Cloud Console has: `https://travelsantamarta.vercel.app/api/auth/google/callback`
- [ ] Vercel `GOOGLE_REDIRECT_URI` is: `https://travelsantamarta.vercel.app/api/auth/google/callback`
- [ ] No trailing slashes
- [ ] No extra spaces
- [ ] Using `https://` (not `http://`)
- [ ] Domain matches exactly (`travelsantamarta.vercel.app`)
...
3. It might be:
   - `travelsantamarta.vercel.app` (default)
   - `travel-santa-marta-xyz.vercel.app` (with random suffix)
   - A custom domain
...
```
redirect_uri=https://travelsantamarta.vercel.app/api/auth/google/callback
```
...
1. Visit: `https://travelsantamarta.vercel.app/api/auth/google`
