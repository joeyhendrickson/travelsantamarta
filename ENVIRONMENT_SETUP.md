...
PINECONE_INDEX_NAME=travel-santa-marta-index
...
2. Click on your project: `travel-santa-marta`
3. Go to **Settings** → **Environment Variables**
4. For each variable, click **"Add New"** and select which environments to apply it to:

#### Production Environment

Set these for **Production** (your live site at `https://travel-santa-marta.vercel.app`):
...
GOOGLE_CLIENT_ID=your_client_id_here
GOOGLE_CLIENT_SECRET=your_client_secret_here
GOOGLE_REDIRECT_URI=https://travel-santa-marta.vercel.app/api/auth/google/callback
GOOGLE_REFRESH_TOKEN=your_refresh_token_here
GOOGLE_DRIVE_FOLDER_ID=your_folder_id_here
NEXT_PUBLIC_APP_URL=https://travel-santa-marta.vercel.app
```

**Important:** 
- `GOOGLE_REDIRECT_URI` must be `https://travel-santa-marta.vercel.app/api/auth/google/callback` for production
...
- Note: Preview URLs are dynamic (e.g., `https://travel-santa-marta-git-branch-username.vercel.app`)
...
2. **In Google Cloud Console:**
   ...
   - Add **both** redirect URIs:
     ...
     - `https://travel-santa-marta.vercel.app/api/auth/google/callback` (for production)
...
| **Production** | Vercel Dashboard → Production | `https://travel-santa-marta.vercel.app/api/auth/google/callback` |
...
### Test Production:
- Visit https://travel-santa-marta.vercel.app
