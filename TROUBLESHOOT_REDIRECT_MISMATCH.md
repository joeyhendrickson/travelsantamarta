...
3. Make sure it's exactly: `https://travelsantamarta.vercel.app/api/auth/google/callback`
4. Save and redeploy
...
Before trying again:
- [ ] `GOOGLE_REDIRECT_URI` in Vercel = `https://travelsantamarta.vercel.app/api/auth/google/callback`
