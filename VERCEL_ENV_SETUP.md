...
1. **Go to your Vercel project:**
   ...
   - Find and click on your project: `travel-santa-marta` (or your project name)
...
- **PINECONE_INDEX_NAME**: Name of your Pinecone index (default: `travel-santa-marta-index`)
