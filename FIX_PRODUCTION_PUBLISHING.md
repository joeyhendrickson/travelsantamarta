...
5. Name it: **"Travel Santa Marta - Production"**
...
GOOGLE_REDIRECT_URI=https://travelsantamarta.vercel.app/api/auth/google/callback
```
...
1. **Temporarily remove localhost redirect URI:**
   ...
   - Keep only: `https://travelsantamarta.vercel.app/api/auth/google/callback`
   - Save
