    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 shadow-sm">
        ...
        <textarea
          ...
          rows={6}
          className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-santa-teal focus:border-santa-teal transition-all bg-white font-mono text-sm"
        ...
        <div className="mt-4 flex items-center gap-4">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              className="w-4 h-4 text-santa-teal border-gray-300 rounded focus:ring-black"
              disabled={isProcessing}
            />
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    {job.title && (
                      <p className="text-sm text-santa-teal/80 mb-2 font-medium">{job.title}</p>
                    )}
                    {job.progress && (
                  ...
                  {job.status === 'completed' && job.transcript && (
                    <button
                      ...
                      className="px-4 py-2 bg-santa-teal text-white rounded-lg text-sm font-semibold hover:bg-santa-tealLight transition-colors flex items-center gap-2"
                    >
                ...
                {job.transcript && (
                  <div className="mt-4 bg-gray-50 border border-gray-200 rounded-lg p-4 max-h-48 overflow-y-auto">
                    ...
                    <p className="text-xs text-santa-teal/80 whitespace-pre-wrap line-clamp-6">
